!function(a) {
    ...
    a.extend(a.jqx._jqxGrid.prototype, {
        ...
        createInstance: function(b) {
            ...
            if (this.source) {
                if (!this.source.dataBind) this.source = new a.jqx.dataAdapter(this.source);
                var d = this.source._source.datafields;
                if (d && d.length > 0) {
                    this._camelCase = void 0 !== this.source._source.dataFields;
            ...
            this.gridtable = null;
            this.isNestedGrid = this.host.parent() ? 2e3 == this.host.parent().css("z-index") : false;
        ...
        localizestrings: function(b, c) {
            ...
            if (null != b) {
                ...
                percentsymbol: languagePack.grid.percentsymbol,
                currencysymbol: languagePack.grid.currencysymbol,
                currencysymbolposition: languagePack.grid.currencysymbolposition,
                decimalseparator: languagePack.grid.decimalseparator,
                thousandsseparator: languagePack.grid.thousandsseparator,
                pagergotopagestring: languagePack.grid.pagergotopagestring,
                pagershowrowsstring: languagePack.grid.pagershowrowsstring,
                pagerrangestring: languagePack.grid.pagerrangestring,
                pagerpreviousbuttonstring: languagePack.grid.pagerpreviousbuttonstring,
                pagernextbuttonstring: languagePack.grid.pagernextbuttonstring,
                pagerfirstbuttonstring: languagePack.grid.pagerfirstbuttonstring,
                pagerlastbuttonstring: languagePack.grid.pagerlastbuttonstring,
                groupsheaderstring: languagePack.grid.groupsheaderstring,
                sortascendingstring: languagePack.grid.sortascendingstring,
                sortdescendingstring: languagePack.grid.sortdescendingstring,
                sortremovestring: languagePack.grid.sortremovestring,
                groupbystring: languagePack.grid.groupbystring,
                groupremovestring: languagePack.grid.groupremovestring,
                filterclearstring: languagePack.grid.filterclearstring,
                filterstring: languagePack.grid.filterstring,
                filtershowrowstring: languagePack.grid.filtershowrowstring,
                filtershowrowdatestring: languagePack.grid.filtershowrowdatestring,
                filterorconditionstring: languagePack.grid.filterorconditionstring,
                filterandconditionstring: languagePack.grid.filterandconditionstring,
                filterselectallstring: languagePack.grid.filterselectallstring,
                filterchoosestring: languagePack.grid.filterchoosestring,
                filterstringcomparisonoperators: languagePack.grid.filterstringcomparisonoperators,
                filternumericcomparisonoperators: languagePack.grid.filternumericcomparisonoperators,
                filterdatecomparisonoperators: languagePack.grid.filterdatecomparisonoperators,
                filterbooleancomparisonoperators: languagePack.grid.filterbooleancomparisonoperators,
                validationstring: languagePack.grid.validationstring,
                emptydatastring: languagePack.grid.emptydatastring,
                filterselectstring: languagePack.grid.filterselectstring,
                loadtext: languagePack.grid.loadtext,
                clearstring: languagePack.grid.clearstring,
                todaystring: languagePack.grid.todaystring
            };
        },
        _initmenu: function() {
            var b = this.that;
        ...
        _setcolumnproperty: function(a, b, c) {
            ...
            switch (b) {
              ...
              case "class":
                this.prerenderrequired = true;
                if ("pinned" == b) this._initializeColumns();
                this.rendergridcontent(true);
                if (this.updating()) return false;
                if ("hidden" == b) {
                    this._updatecolumnwidths();
        ...
        _render: function(b, c, d, e, f) {
            ...
            if (d) {
                ...
                if (null == this.columns) this.columns = new a.jqx.collection(this.element); else this._initializeColumns();
            }
            this.tableheight = null;
            this._pagescache = new Array();
            this._pageviews = new Array();
            ...
            if (this.showfilterrow && this.filterable) this.columnsheader.height(h + this.filterrowheight); else this.columnsheader.height(h);
            ...
            if (this.groups.length > 0 && this.groupable) {
                var i = this.vScrollBar[0].style.visibility;
                ...
                if (this.vScrollBar[0].style.visibility != i) {
                    this._updatecolumnwidths();
                    this._updatecellwidths();
                }
        ...
        _handlecolumnsmenu: function(b, c, d, e, f) {
            ...
            var n = function() {
                ...
                if (null != i && null != j && null != m) {
                    ...
                    if (f.datafield) if (b.sortcolumn == f.datafield) {
        ...
        setcellvalue: function(b, c, d, e, f) {
            ...
            if (null != i && i[c] !== d) {
                ...
                i[c] = d;
                var r = this.getrenderedrowdata(g, true);
                if (!r) return;
                r[c] = d;
                if (null != d && null != d.label) {
                    var m = this._getcolumnbydatafield(c);
                    i[m.displayfield] = d.label;
                    r[m.displayfield] = d.label;
                    i[c] = d.value;
                    r[c] = d.value;
                }
            ...
            if (this.source && this.source._knockoutdatasource && !this._updateFromAdapter && this.autokoupdates) if (this.source._source._localdata) {
                var s = g;
                if (j) if (void 0 != i.dataindex) s = i.dataindex;
                var t = this.source._source._localdata()[s];
                this.source.suspendKO = true;
                var u = t;
                if (u[c] && u[c].subscribe) if (null != d && null != d.label) {
                    u[m.displayfield](d.label);
                    u[c](d.value);
                } else u[c](d); else {
                    ...
                    if (null == w) if (null != d && null != d.label) {
                        u[c] = d.value;
                        u[m.displayfield] = d.label;
                    } else u[c] = d; else {
                        var x = w.split(this.source.mapChar);
                        if (x.length > 0) {
                            var y = u;
                            for (var z = 0; z < x.length - 1; z++) y = y[x[z]];
                            y[x[x.length - 1]] = d;
                        }
                    }
                    this.source._source._localdata.replace(t, a.extend({}, u));
                }
                this.source.suspendKO = false;
            }
            if (this.sortcolumn && this.dataview.sortby && !this._updating) {
                var A = this.getsortinformation();
                if (this.sortcolumn == c) {
                    this.dataview.clearsortdata();
                    this.dataview.sortby(A.sortcolumn, A.sortdirection.ascending);
                }
            ...
            if (this.source.updaterow && (void 0 == f || true == f)) {
                ...
                var D = function(a) {
                    if (false == a) {
                        C.setcellvalue(b, c, k, true, false);
                        if (k != l) C.setcellvalue(b, C.getcolumn(c).displayfield, l, true, false);
                    }
                };
                try {
                    var E = this.getrowid(g);
                    B = this.source.updaterow(E, i, D);
                    if (void 0 == B) B = true;
                } catch (F) {
                    B = false;
                    C.setcellvalue(b, c, k, true, false);
            ...
            if (true == e || void 0 == e) {
                var C = this.that;
                var H = function() {
                    if (C.pageable && C.updatepagerdetails) {
                        C.updatepagerdetails();
                        if (C.autoheight || C.autorowheight) C._updatepageviews();
                    }
                };
            ...
            if (this.showfilterrow && this.filterable && this.filterrow) {
                ...
                if ("list" == J || "checkedlist" == J) this._updatelistfilters(true);
            }
            this._raiseEvent(19, {
                rowindex: b,
                datafield: c,
        ...
        deleterow: function(b, c) {
            if (void 0 != b) {
                ...
                var g = function(b, d) {
                    ...
                    if (b.dataview.sortby) b.dataview.clearsortdata();
                    b.vScrollInstance.setPosition(f);
                    return e;
                };
        ...
        _prerenderrows: function(b) {
            ...
            if (true == c.prerenderrequired) {
                ...
                if (c.groupable && (c.autoheight || c.autorowheight) && !c.pageable) g = c.dataview.rows.length;
            ...
            if (null != s && y >= 0) {
                ...
                if (u.indexOf("jqx-grid-group-expand") != -1 || u.indexOf("jqx-grid-group-collapse") != -1) {
                    ...
                    if ("none" != c.selectionmode && "checkbox" != c.selectionmode && this._selectrowwithmouse) {
                        if ("multiplecellsadvanced" == c.selectionmode || "multiplecellsextended" == c.selectionmode || "multiplerowsextended" == c.selectionmode || "multiplerowsadvanced" == c.selectionmode) if (!b.ctrlKey && !b.shiftKey) {
                        ...
                        if (c.selectionmode.indexOf("cell") == -1) {
                            if ("singlerow" != c.selectionmode || c.selectedrowindex != K && "singlerow" == c.selectionmode) {
                                ...
                                this._selectrowwithmouse(c, r, H, C.datafield, b.ctrlKey, b.shiftKey);
                            }
            ...
            switch (c) {
              ...
              case "theme":
                if (e != d) {
                    if (b.pager) {
                        b.pager.removeClass();
                        b.pager.addClass(b.toTP("jqx-grid-pager"));
                        b.pager.addClass(b.toTP("jqx-widget-header"));
                        if (b.pageable && b._updatepagertheme) b._updatepagertheme();
                    }
                    if (b.groupsheader) {
                        b.groupsheader.removeClass();
                        b.groupsheader.addClass(b.toTP("jqx-grid-groups-header"));
                        b.groupsheader.addClass(b.toTP("jqx-widget-header"));
                    }
                    b.toolbar.removeClass();
                    b.toolbar.addClass(b.toTP("jqx-grid-toolbar"));
                    b.toolbar.addClass(b.toTP("jqx-widget-header"));
                    b.statusbar.removeClass();
                    b.statusbar.addClass(b.toTP("jqx-grid-statusbar"));
                    b.statusbar.addClass(b.toTP("jqx-widget-content"));
                    b.vScrollBar.jqxScrollBar({
                        theme: b.theme
                    });
                    b.hScrollBar.jqxScrollBar({
                    ...
                    b.host.removeClass();
                    b.host.addClass(b.toTP("jqx-grid"));
                    b.host.addClass(b.toTP("jqx-reset"));
                    b.host.addClass(b.toTP("jqx-rc-all"));
                    b.host.addClass(b.toTP("jqx-widget"));
                    b.host.addClass(b.toTP("jqx-widget-content"));
                    b.bottomRight.removeClass();
                    b.bottomRight.addClass(b.toTP("jqx-grid-bottomright"));
                    b.bottomRight.addClass(b.toTP("jqx-scrollbar-state-normal"));
                    b.toolbar.addClass(b.toTP("jqx-grid-toolbar"));
                    b.toolbar.addClass(b.toTP("jqx-widget-header"));
                    b.statusbar.addClass(b.toTP("jqx-grid-statusbar"));
                    b.statusbar.addClass(b.toTP("jqx-widget-header"));
                    b.render();
                }
                break;
              ...
              case "tab":
                if (null != b.localdata) {
                    ...
                    var i = function(a) {
                        ...
                        if ("updateData" == a) {
                            ...
                            if (b.recordstartindex) h.updateview(b.recordstartindex, b.recordstartindex + h.pagesize); else h.refresh();
                ...
                for (var m = 0; m < this.filters.length; m++) {
                    ...
                    for (var q = 0; q < p.length; q++) {
                        ...
                        } else l["filtervalue" + k] = r.toString(); else l["filtervalue" + k] = r.toString();
                ...
                if (void 0 == b.recordendindex || 0 == b.recordendindex) {
                    if (h.grid.height && h.grid.height.toString().indexOf("%") == -1) {
                        ...
                        b.recordendindex += 2;
                    } else b.recordendindex = a(window).height() / h.grid.rowsheight;
